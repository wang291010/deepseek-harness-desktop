...
export interface DesktopPnpmService {
    run(args: string[]): DesktopPnpmOperation;
}
/** Bind DSH Desktop's managed, shell-free packaged pnpm capability. */
export declare function configureDesktopPnpm(service: DesktopPnpmService): void;
/** Validate an npm package name before any registry or install operation. */
export declare function validPackageName(value: string): boolean;
...
/** Run packaged pnpm through DSH Desktop's managed subprocess service. */
